...
///
/// Aligné sur les enums Prisma backend. ALCOHOL existe dans l'enum DB mais
/// n'est jamais proposé côté UI (pivot lancement Lilia Food — pas de vente
/// d'alcool, cf. memory `project-lilia-no-alcohol-initial`).
