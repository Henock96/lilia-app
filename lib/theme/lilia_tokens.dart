...
class LiliaColors {
  ...
  /// Gris de texte secondaire conforme WCAG AA sur les fonds clairs.
  /// `charcoal400` ne donnait que 4.36:1 sur `cream100` (seuil : 4.5:1).
  static const charcoal450 = Color(0xFF6E665F);
...
class LiliaSemantics {
  ...
  static const light = LiliaThemeTokens(
    ...
    // charcoal400 tombait à 4.36:1 sur cream100 — sous le seuil AA, et il
    // porte bodySmall/labelSmall, souvent rendus en 11 px.
    textMuted: LiliaColors.charcoal450,
    textInverse: Colors.white,
    // orange500 + blanc = 3.67:1, sous AA pour du texte normal — or c'est le
    // fond de TOUS les boutons d'action. orange600 remonte à 4.94:1 en gardant
    // l'identité orange.
  ...
  static const dark = LiliaThemeTokens(
    ...
    // orange400 est trop clair pour du blanc (2.84:1, sous le seuil même pour
    // du grand texte). Un texte foncé donne 6.20:1 — c'est aussi ce que fait
    // Material 3 en dérivant `onPrimary` de la luminance du fond.
...
class LiliaThemeTokens {
  ...
  /// Couleur de texte à poser sur [actionPrimary]. Ne jamais coder `Colors.white`
  /// en dur : en thème sombre l'action est un orange clair, sur lequel le blanc
  /// n'est pas lisible.
